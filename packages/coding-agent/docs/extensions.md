...
| Package | Purpose |
|---------|---------|
| `@lunezhang/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@lunezhang/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@lunezhang/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@lunezhang/pi-coding-agent";
...
```typescript
import { withFileMutationQueue } from "@lunezhang/pi-coding-agent";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@lunezhang/pi-coding-agent";
...
```typescript
import { createBashTool } from "@lunezhang/pi-coding-agent";
...
```typescript
import { keyHint } from "@lunezhang/pi-coding-agent";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@lunezhang/pi-coding-agent";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@lunezhang/pi-coding-agent";
